...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(r + ", CentrePoint is: " + r.getCentrePoint()
                + ", Area is: " + r.getArea()
                + ". Is it square? " + r.isSquare());
        System.out.println(r2 + ", CentrePoint is: " + r2.getCentrePoint()
                + ", Area is: " + r2.getArea()
        ...
        Circle c3 = new Circle("circle3", "blue", 10, 10 ,5);

        System.out.println(c3);
        System.out.println("Circle location before move" + c3.getCurrentLocation());
        c3.move(10.5, 4.3);

        System.out.println("Circle location after move "+c3.getCurrentLocation());
    }
